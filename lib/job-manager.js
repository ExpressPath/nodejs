...
const { executeProofCheckJob, executeLambdaConversionJob } = require('./helper-service');
...
jobManager.register('proof-check', executeProofCheckJob);
jobManager.register('lambda-convert', executeLambdaConversionJob);
